...
/*---- le type cellule de liste des int ----*/
typedef struct Cellule_Liste_Point_
{
	int data;    /* donn�e de l'�l�ment de liste */
...
typedef struct Tableau_Point_
{
	...
	int *tab;          /* (pointeur vers) le tableau des �l�ments */
} Tableau_Point;
...
Cellule_Liste_Point *creer_element_liste_Point(int v);

/* cr�er une liste vide */
Liste_Point creer_liste_Point_vide();

/* ajouter l'�l�ment e en fin de la liste L, renvoie la liste L modifi�e */
void ajouter_element_liste_Point(Liste_Point *L, int e);
